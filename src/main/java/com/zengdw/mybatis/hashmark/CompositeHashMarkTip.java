...
import com.zengdw.mybatis.annotation.Annotation;
...
public class CompositeHashMarkTip {
     ...
     * <p>
     * 提示的内容参考:
     * see <a href="https://mybatis.org/mybatis-3/zh/sqlmap-xml.html#select">https://mybatis.org/mybatis-3/zh/sqlmap-xml.html#select</a>
     *
     * @param wrappedText
     * @param editorCaret
     */
