...
import com.zengdw.mybatis.vo.IntellijColumnInfo;
import com.zengdw.mybatis.vo.IntellijTableInfo;
...
public class DbToolsUtils {
    ...
    public static IntellijColumnInfo convertColumnToIntellijColumnInfo(DasColumn column, String databaseType) {
        ...
        columnInfo.setDataType(convertTypeNameToJdbcType(column.getDataType().typeName, databaseType));
